...
void ScriptManager::RegisterGame()
{
	...
	AddType("Quest")
		...
		.Method("void SetFailed(bool = false)", asMETHOD(Quest_Scripted, SetFailed))
		.Method("void SetCompleted(bool = false)", asMETHOD(Quest_Scripted, SetCompleted))
		.Method("void Restart()", asMETHOD(Quest_Scripted, Restart))
	...
	AddType("Class")
		.Method("string GenerateName(bool)", asMETHOD(Class, GenerateName))
		.WithNamespace()
