...
Spell g_spells[] = {
	...
	Spell(4, "raise", Spell::Target, Spell::Raise | Spell::NonCombat, 0, 0, VEC2(10.f, 15.f), 15.f, 0.f, NULL, "czarna_iskra.png", NULL, 1.f, 0.1f, "Darkness3.ogg", NULL, VEC2(2, 5), VEC2(0, 0), 0.f, NULL),
	...
	Spell(9, "heal", Spell::Target, Spell::Heal | Spell::NonCombat, 100, 10, VEC2(10.f, 15.f), 15.f, 0.f, NULL, "heal.png", NULL, 1.f, 0.03f, "heal.ogg", NULL, VEC2(2, 5), VEC2(0, 0), 0.f, NULL),
	Spell(10, "mystic_ball", Spell::Point, Spell::Explode, 200, 0, VEC2(10.f,10.f), 50.f, 18.f, "flare2.png", "flare2.png", "rainbow.jpg", 0.2f, 0.075f, "rlaunch.mp3", "explode.mp3", VEC2(2,8), VEC2(4,15), 3.f, NULL)
};
