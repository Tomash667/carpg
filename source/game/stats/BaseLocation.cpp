...
BaseLocation g_base_locations[] = {
	...
	"Fort ludzi", /*"Human fort"*/					INT2(2, 3),		40, 2,		40, 20,		30,			INT2(3,12),	INT2(5,10),	0, RoomStr("schody"), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.3f,0.3f,0.3f), VEC3(-0.025f,-0.025f,-0.025f), VEC2(10,20), VEC2(-0.5f,-1.f), 20.f, -1.f,
		fort_ludzi_pokoje, countof(fort_ludzi_pokoje), 0, NULL, NULL, NULL, 50, 25, 2,
		SG_LOSOWO, SG_LOSOWO, SG_LOSOWO, 0, 0, 0, 0, -1,
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Fort krasnoludów", /*"Dwarf fort"*/			INT2(3, 5),		40, 3,		50, 5,		25,			INT2(5,12),	INT2(4,8),	0, RoomStr("schody"), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.3f,0.3f,0.3f), VEC3(-0.025f,-0.025f,-0.025f), VEC2(10,20), VEC2(-0.5f,-1.f), 20.f, -1.f,
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Wie¿a magów", /*"Mage tower"*/					INT2(4, 6),		30, 0,		0,	33,		0,			INT2(0,0),	INT2(4,7),	BLO_MAGIC_LIGHT|BLO_ROUND, RoomStr("schody"), RoomStr(NULL),
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Kryjówka bandytów", /*"Bandits hideout"*/		INT2(2, 3),		40, 2,		40, 20,		30,			INT2(3,12),	INT2(5,10),	0, RoomStr("schody"), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.3f,0.3f,0.3f), VEC3(-0.025f,-0.025f,-0.025f), VEC2(10,20), VEC2(-0.5f,-1.f), 20.f, -1.f,
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Krypta bohatera", /*"Hero crypt"*/				INT2(2, 3),		35, 5,		30, 10,		25,			INT2(5,10),	INT2(5,10),	BLO_MAGIC_LIGHT|BLO_LESS_FOOD, RoomStr("schody"), RoomStr(NULL),
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Krypta potwora", /*"Monster crypt"*/			INT2(2, 3),		35, 5,		30, 10,		25,			INT2(5,10),	INT2(5,10),	BLO_MAGIC_LIGHT|BLO_LESS_FOOD, RoomStr("schody"), RoomStr(NULL),
		VEC3(40.f/255,40.f/255,40.f/255), VEC3(5.f/255,5.f/255,5.f/255), VEC3(0.25f,0.25f,0.25f), VEC3(-0.04f,-0.04f,-0.04f), VEC2(5.f,18.f), VEC2(-0.5f,-0.5f), 18.f, -0.5f,
		krypta_pokoje, countof(krypta_pokoje), 0, "floor_pavement_stone5_2.jpg", "256-01a.jpg", "sufit2.jpg", 80, 5, 1,
		SG_NIEUMARLI, SG_NEKRO, SG_LOSOWO, 50, 25, 0, TRAPS_NORMAL|TRAPS_NEAR_END, CRYPT_2_TEXTURE,
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Stara œwi¹tynia", /*"Old temple"*/				INT2(1, 3),		40, 2,		35, 15,		25,			INT2(5,10),	INT2(4,8),	BLO_MAGIC_LIGHT|BLO_LESS_FOOD, RoomStr("schody_swiatynia"), RoomStr("kapliczka"),
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Skrytka", /*"Safehouse"*/						INT2(1, 1),		30, 0,		50,	5,		35,			INT2(5,12),	INT2(4,7),	0, RoomStr("schody"), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.3f,0.3f,0.3f), VEC3(-0.025f,-0.025f,-0.025f), VEC2(10,20), VEC2(-0.5f,-1.f), 20.f, -1.f,
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Baza nekromantów", /*"Necromancers base"*/		INT2(2, 3),		45, 3,		35,	15,		25,			INT2(5,10),	INT2(5,10), BLO_MAGIC_LIGHT|BLO_LESS_FOOD, RoomStr("schody_swiatynia"), RoomStr(NULL),
		VEC3(40.f/255,40.f/255,40.f/255), VEC3(5.f/255,5.f/255,5.f/255), VEC3(0.25f,0.25f,0.25f), VEC3(-0.04f,-0.04f,-0.04f), VEC2(5.f,18.f), VEC2(-0.5f,-0.5f), 18.f, -0.5f,
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Labirynt", /*"Labirynth"*/						INT2(1, 1),		60, 0,		0, 0,		0,			INT2(0,0),	INT2(6,6),	BLO_LABIRYNTH, RoomStr(NULL), RoomStr(NULL),
		...
		SG_LOSOWO, SG_LOSOWO, SG_LOSOWO, 0, 0, 0, 0, -1,
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Jaskinia", /*"Cave"*/							INT2(0,0),		52, 0,		0, 0,		0,			INT2(0,0),	INT2(0,0),	BLO_LABIRYNTH,	RoomStr(NULL), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.4f,0.4f,0.4f), VEC3(0,0,0), VEC2(16.f,25.f), VEC2(0,0), 25.f, 0,
		NULL, 0, 0, "rock2.jpg", "rock1.jpg", "rock3.jpg", 0, 0, 0,
		SG_LOSOWO, SG_LOSOWO, SG_LOSOWO, 0, 0, 0, 0, KOPALNIA_POZIOM,
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Staro¿ytna zbrojownia", /*"Ancient armory"*/	INT2(1,1),		45, 0,		35, 0,		25,			INT2(5,10),	INT2(4,8),	BLO_MAGIC_LIGHT|BLO_LESS_FOOD, RoomStr("schody_swiatynia"), RoomStr(NULL),
		VEC3(40.f/255,40.f/255,40.f/255), VEC3(5.f/255,5.f/255,5.f/255), VEC3(0.25f,0.25f,0.25f), VEC3(-0.04f,-0.04f,-0.04f), VEC2(5.f,18.f), VEC2(-0.5f,-0.5f), 18.f, -0.5f,
		...
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Samouczek",									INT2(1,1),		22, 0,		40, 20,		30,			INT2(3,12),	INT2(5,10),	0, RoomStr("schody"), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.3f,0.3f,0.3f), VEC3(-0.025f,-0.025f,-0.025f), VEC2(10,20), VEC2(-0.5f,-1.f), 20.f, -1.f,
		tut_pokoje, countof(tut_pokoje), 0, NULL, NULL, NULL, 100, 0, 0,
		SG_LOSOWO, SG_LOSOWO, SG_LOSOWO, 0, 0, 0, 0, -1,
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Fort z tronem",								INT2(2, 3),		40, 2,		40, 20,		30,			INT2(3,12),	INT2(5,10),	0, RoomStr("schody"), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.3f,0.3f,0.3f), VEC3(-0.025f,-0.025f,-0.025f), VEC2(10,20), VEC2(-0.5f,-1.f), 20.f, -1.f,
		fort_ludzi_pokoje, countof(fort_ludzi_pokoje), 0, NULL, NULL, NULL, 50, 25, 2,
		SG_LOSOWO, SG_LOSOWO, SG_LOSOWO, 0, 0, 0, 0, -1,
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Skrytka z tronem",								INT2(1, 1),		35, 0,		50,	5,		35,			INT2(5,12),	INT2(4,7),	0, RoomStr("schody"), RoomStr(NULL),
		VEC3(0,0,0), VEC3(0,0,0), VEC3(0.3f,0.3f,0.3f), VEC3(-0.025f,-0.025f,-0.025f), VEC2(10,20), VEC2(-0.5f,-1.f), 20.f, -1.f,
		skrytka_pokoje, countof(skrytka_pokoje), 0, "mad015.jpg", "mad063.jpg", "mad013.jpg", 100, 0, 3,
		SG_BANDYCI, SG_BRAK, SG_LOSOWO, 25, 25, 0, TRAPS_NORMAL, -1,
		NULL, NULL, NULL, NULL, NULL, NULL,
	"Krypta 2-tekstura",							INT2(2, 3),		35, 5,		30, 10,		25,			INT2(5,10),	INT2(4,8),	BLO_MAGIC_LIGHT|BLO_LESS_FOOD, RoomStr("schody"), RoomStr(NULL),
		VEC3(40.f/255,40.f/255,40.f/255), VEC3(5.f/255,5.f/255,5.f/255), VEC3(0.25f,0.25f,0.25f), VEC3(-0.04f,-0.04f,-0.04f), VEC2(5.f,18.f), VEC2(-0.5f,-0.5f), 18.f, -0.5f,
