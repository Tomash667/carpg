...
Armor g_armors[] = {
	...
	Armor("am_scale_hq",			250,	150,	"kolczuga.qmsh",			Skill::MEDIUM_ARMOR,	ArmorUnitType::HUMAN,	MAT_IRON,		29, 50, 60, ITEM_HQ, 0),
	Armor("am_scale_m",				1150,	135,	"kolczuga.qmsh",			Skill::MEDIUM_ARMOR,	ArmorUnitType::HUMAN,	MAT_IRON,		35, 45, 60, ITEM_MAGICAL, 0),
	Armor("am_dragonscale",			8150,	165,	"kolczuga.qmsh",			Skill::MEDIUM_ARMOR,	ArmorUnitType::HUMAN,	MAT_IRON,		60, 50, 50, ITEM_MAGICAL, 0),
