		...
		case NetChange::ATTACK:
			{
				...
				else if(game->game_state == GS_LEVEL)
				{
					...
					case AID_StartShoot:
						...
						{
							unit.node->mesh_inst->Play(NAMES::ani_shoot, PLAY_PRIO1 | PLAY_ONCE, 1);
							unit.node->mesh_inst->groups[1].speed = attack_speed;
							unit.action = A_SHOOT;
					...
					case AID_Block:
						{
							unit.action = A_BLOCK;
							unit.node->mesh_inst->Play(NAMES::ani_block, PLAY_PRIO1 | PLAY_STOP_AT_END, 1);
					...
					case AID_Bash:
						{
							unit.action = A_BASH;
							unit.animation_state = 0;
							unit.node->mesh_inst->Play(NAMES::ani_bash, PLAY_ONCE | PLAY_PRIO1, 1);
							unit.node->mesh_inst->groups[1].speed = attack_speed;
							unit.hitted = false;
