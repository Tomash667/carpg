...
Skill Skill::skills[(int)SkillId::MAX] = {
	Skill(SkillId::ONE_HANDED_WEAPON, "oneHandedWeapon", SkillGroupId::WEAPON, AttributeId::STR, AttributeId::DEX),
	Skill(SkillId::SHORT_BLADE, "shortBlade", SkillGroupId::WEAPON, AttributeId::DEX, AttributeId::NONE, SkillType::WEAPON),
	Skill(SkillId::LONG_BLADE, "longBlade", SkillGroupId::WEAPON, AttributeId::STR, AttributeId::DEX, SkillType::WEAPON),
	...
	Skill(SkillId::LIGHT_ARMOR, "lightArmor", SkillGroupId::ARMOR, AttributeId::DEX, AttributeId::NONE, SkillType::ARMOR),
	Skill(SkillId::MEDIUM_ARMOR, "mediumArmor", SkillGroupId::ARMOR, AttributeId::END, AttributeId::DEX, SkillType::ARMOR),
	Skill(SkillId::HEAVY_ARMOR, "heavyArmor", SkillGroupId::ARMOR, AttributeId::STR, AttributeId::END, SkillType::ARMOR),
	Skill(SkillId::NATURE_MAGIC, "natureMagic", SkillGroupId::MAGIC, AttributeId::WIS, AttributeId::NONE),
	Skill(SkillId::GODS_MAGIC, "godsMagic", SkillGroupId::MAGIC, AttributeId::CHA, AttributeId::NONE, SkillType::NONE, true),
	Skill(SkillId::MYSTIC_MAGIC, "mysticMagic", SkillGroupId::MAGIC, AttributeId::INT, AttributeId::NONE, SkillType::NONE, true),
	Skill(SkillId::SPELLCRAFT, "spellcraft", SkillGroupId::MAGIC, AttributeId::INT, AttributeId::WIS),
	Skill(SkillId::CONCENTRATION, "concentration", SkillGroupId::MAGIC, AttributeId::WIS, AttributeId::END, SkillType::NONE, true),
	...
	Skill(SkillId::ANIMAL_EMPATHY, "animalEmpathy", SkillGroupId::OTHER, AttributeId::CHA, AttributeId::WIS),
