...
Skill Skill::skills[(int)SkillId::MAX] = {
	...
	Skill(SkillId::GODS_MAGIC, "gods_magic", SkillGroupId::MAGIC, AttributeId::CHA, AttributeId::NONE, SkillType::NONE, true),
	Skill(SkillId::MYSTIC_MAGIC, "mystic_magic", SkillGroupId::MAGIC, AttributeId::INT, AttributeId::NONE, SkillType::NONE, true),
