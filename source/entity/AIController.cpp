...
{
	if(!(unit->action == A_NONE && (unit->meshInst->GetMesh()->head.nGroups == 1 || unit->weaponState == WeaponState::Taken) && nextAttack <= 0.f))
		return;
