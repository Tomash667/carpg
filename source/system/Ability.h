...
struct Ability
{
	...
	Ability() : soundCast(nullptr), soundHit(nullptr), tex(nullptr), texParticle(nullptr), texIcon(nullptr), particleEffect(nullptr), shape(nullptr), mesh(nullptr), type(Point),
