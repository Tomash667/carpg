...
Available commands:
	...
	mod_stat - modify player statistics (mod_stat stat value), use mod_stat ? to get list of stats.
	...
	set_stat - set player statistics (set_stat stat value), use set_stat ? to get list of stats.
