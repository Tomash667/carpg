...
BaseLocation g_base_locations[] = {
	...
	"Fort ludzi", /*"Human fort"*/					Int2(2, 3),		40, 2,		40, 20,		30,			Int2(1,10),	Int2(3,8),	0, RoomStr("schody"), RoomStr(nullptr),
		...
		LocationTexturePack(),
	"Fort krasnoludów", /*"Dwarf fort"*/			Int2(3, 5),		40, 3,		50, 5,		25,			Int2(3,10),	Int2(2,6),	0, RoomStr("schody"), RoomStr(nullptr),
		Vec3(0,0,0), Vec3(0,0,0), Vec3(0.3f,0.3f,0.3f), Vec3(-0.025f,-0.025f,-0.025f), Vec2(10,20), Vec2(-0.5f,-1.f), 20.f, -1.f,
	...
	"Wie¿a magów", /*"Mage tower"*/					Int2(4, 6),		30, 0,		0,	33,		0,			Int2(0,0),	Int2(2,5),	BLO_MAGIC_LIGHT | BLO_ROUND, RoomStr("schody"), RoomStr(nullptr),
	...
	"Kryjówka bandytów", /*"Bandits hideout"*/		Int2(2, 3),		40, 2,		40, 20,		30,			Int2(1,10),	Int2(3,8),	0, RoomStr("schody"), RoomStr(nullptr),
		Vec3(0,0,0), Vec3(0,0,0), Vec3(0.3f,0.3f,0.3f), Vec3(-0.025f,-0.025f,-0.025f), Vec2(10,20), Vec2(-0.5f,-1.f), 20.f, -1.f,
	...
	"Krypta bohatera", /*"Hero crypt"*/				Int2(2, 3),		35, 5,		30, 10,		25,			Int2(3,8),	Int2(3,8),	BLO_MAGIC_LIGHT | BLO_LESS_FOOD, RoomStr("schody"), RoomStr(nullptr),
	...
	"Krypta potwora", /*"Monster crypt"*/			Int2(2, 3),		35, 5,		30, 10,		25,			Int2(3,8),	Int2(3,8),	BLO_MAGIC_LIGHT | BLO_LESS_FOOD, RoomStr("schody"), RoomStr(nullptr),
		Vec3(40.f / 255,40.f / 255,40.f / 255), Vec3(5.f / 255,5.f / 255,5.f / 255), Vec3(0.25f,0.25f,0.25f), Vec3(-0.04f,-0.04f,-0.04f), Vec2(5.f,18.f), Vec2(-0.5f,-0.5f), 18.f, -0.5f,
		krypta_pokoje, countof(krypta_pokoje), 0, 80, 5, 1, SG_NIEUMARLI, SG_NEKRO, SG_LOSOWO, 50, 25, 0, TRAPS_NORMAL | TRAPS_NEAR_END, CRYPT_2_TEXTURE,
		LocationTexturePack("floor_pavement_stone5_2.jpg", "256-01a.jpg", "sufit2.jpg"),
	"Stara œwi¹tynia", /*"Old temple"*/				Int2(1, 3),		40, 2,		35, 15,		25,			Int2(3,8),	Int2(2,6),	BLO_MAGIC_LIGHT | BLO_LESS_FOOD, RoomStr("schody_swiatynia"), RoomStr("kapliczka"),
		Vec3(40.f / 255,40.f / 255,40.f / 255), Vec3(5.f / 255,5.f / 255,5.f / 255), Vec3(0.25f,0.25f,0.25f), Vec3(-0.04f,-0.04f,-0.04f), Vec2(5.f,18.f), Vec2(-0.5f,-0.5f), 18.f, -0.5f,
	...
	"Skrytka", /*"Safehouse"*/						Int2(1, 1),		30, 0,		50,	5,		35,			Int2(3,10),	Int2(2,5),	0, RoomStr("schody"), RoomStr(nullptr),
		Vec3(0,0,0), Vec3(0,0,0), Vec3(0.3f,0.3f,0.3f), Vec3(-0.025f,-0.025f,-0.025f), Vec2(10,20), Vec2(-0.5f,-1.f), 20.f, -1.f,
	...
	"Baza nekromantów", /*"Necromancers base"*/		Int2(2, 3),		45, 3,		35,	15,		25,			Int2(3,8),	Int2(3,8), BLO_MAGIC_LIGHT | BLO_LESS_FOOD, RoomStr("schody_swiatynia"), RoomStr(nullptr),
		Vec3(40.f / 255,40.f / 255,40.f / 255), Vec3(5.f / 255,5.f / 255,5.f / 255), Vec3(0.25f,0.25f,0.25f), Vec3(-0.04f,-0.04f,-0.04f), Vec2(5.f,18.f), Vec2(-0.5f,-0.5f), 18.f, -0.5f,
	...
	"Staro¿ytna zbrojownia", /*"Ancient armory"*/	Int2(1,1),		45, 0,		35, 0,		25,			Int2(3,8),	Int2(2,6),	BLO_MAGIC_LIGHT | BLO_LESS_FOOD, RoomStr("schody_swiatynia"), RoomStr(nullptr),
		Vec3(40.f / 255,40.f / 255,40.f / 255), Vec3(5.f / 255,5.f / 255,5.f / 255), Vec3(0.25f,0.25f,0.25f), Vec3(-0.04f,-0.04f,-0.04f), Vec2(5.f,18.f), Vec2(-0.5f,-0.5f), 18.f, -0.5f,
		fort_ludzi_pokoje, countof(fort_ludzi_pokoje), 0, 80, 5, 1, SG_GOLEMY, SG_BRAK, SG_BRAK, 100, 0, 0, TRAPS_MAGIC | TRAPS_NORMAL, -1,
		LocationTexturePack("floor_tile_ceramicBlue.jpg", "block10c.jpg", "woodmgrid1a.jpg"),
	"Samouczek",									Int2(1,1),		22, 0,		40, 20,		30,			Int2(1,10),	Int2(3,8),	0, RoomStr("schody"), RoomStr(nullptr),
		Vec3(0,0,0), Vec3(0,0,0), Vec3(0.3f,0.3f,0.3f), Vec3(-0.025f,-0.025f,-0.025f), Vec2(10,20), Vec2(-0.5f,-1.f), 20.f, -1.f,
		tut_pokoje, countof(tut_pokoje), 0, 100, 0, 0, SG_LOSOWO, SG_LOSOWO, SG_LOSOWO, 0, 0, 0, 0, -1,
		LocationTexturePack(),
	"Fort z tronem",								Int2(2, 3),		40, 2,		40, 20,		30,			Int2(1,10),	Int2(3,8),	0, RoomStr("schody"), RoomStr(nullptr),
		Vec3(0,0,0), Vec3(0,0,0), Vec3(0.3f,0.3f,0.3f), Vec3(-0.025f,-0.025f,-0.025f), Vec2(10,20), Vec2(-0.5f,-1.f), 20.f, -1.f,
		fort_ludzi_pokoje, countof(fort_ludzi_pokoje), 0, 50, 25, 2, SG_LOSOWO, SG_LOSOWO, SG_LOSOWO, 0, 0, 0, 0, -1,
		LocationTexturePack(),
	"Skrytka z tronem",								Int2(1, 1),		35, 0,		50,	5,		35,			Int2(3,10),	Int2(2,5),	0, RoomStr("schody"), RoomStr(nullptr),
		Vec3(0,0,0), Vec3(0,0,0), Vec3(0.3f,0.3f,0.3f), Vec3(-0.025f,-0.025f,-0.025f), Vec2(10,20), Vec2(-0.5f,-1.f), 20.f, -1.f,
		skrytka_pokoje, countof(skrytka_pokoje), 0, 100, 0, 3, SG_BANDYCI, SG_BRAK, SG_LOSOWO, 25, 25, 0, TRAPS_NORMAL, -1,
		LocationTexturePack("mad015.jpg", "mad063.jpg", "mad013.jpg"),
	"Krypta 2-tekstura",							Int2(2, 3),		35, 5,		30, 10,		25,			Int2(3,8),	Int2(2,6),	BLO_MAGIC_LIGHT | BLO_LESS_FOOD, RoomStr("schody"), RoomStr(nullptr),
		Vec3(40.f / 255,40.f / 255,40.f / 255), Vec3(5.f / 255,5.f / 255,5.f / 255), Vec3(0.25f,0.25f,0.25f), Vec3(-0.04f,-0.04f,-0.04f), Vec2(5.f,18.f), Vec2(-0.5f,-0.5f), 18.f, -0.5f,
