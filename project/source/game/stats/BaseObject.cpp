...
BaseObject BaseObject::objs[] = {
	...
	BaseObject("tent", OBJ_PHY_BLOCKS_CAM, 0, "Tent", "namiot.qmsh"),
	BaseObject("hay", OBJ_NEAR_WALL, 0, "Hay", "snopek.qmsh"),
	BaseObject("firewood", OBJ_NEAR_WALL, 0, "Firewood", "drewno_na_opal.qmsh"),
	BaseObject("wardrobe", OBJ_NEAR_WALL | OBJ_PHY_BLOCKS_CAM, 0, "Wardrobe", "szafa.qmsh"),
	BaseObject("bed", OBJ_NEAR_WALL | OBJ_PHY_BLOCKS_CAM, 0, "Bed", "lozko.qmsh"),
	...
	BaseObject("bench", OBJ_NEAR_WALL | OBJ_USABLE | OBJ_BENCH, OBJ2_VARIANT, "Bench", nullptr, -1, 0.f, &bench_variant),
	BaseObject("bench_dir", OBJ_NEAR_WALL | OBJ_USABLE, OBJ2_BENCH_ROT | OBJ2_VARIANT, "Rotated bench", nullptr, -1, 0.f, &bench_variant),
	...
	BaseObject("anvil", OBJ_USABLE | OBJ_ANVIL, 0, "Anvil", "kowadlo.qmsh"),
	BaseObject("cauldron", OBJ_USABLE | OBJ_CAULDRON, 0, "Cauldron", "kociol.qmsh"),
	...
	BaseObject("withered_tree", OBJ_SCALEABLE | OBJ_PHY_BLOCKS_CAM, 0, "Withered tree", "drzewo_uschniete.qmsh", 0.58f, 6.f),
	BaseObject("tartak", OBJ_BUILDING, 0, "Sawmill", "tartak.qmsh", 0.f, 0.f),
	BaseObject("iron_ore", OBJ_USABLE | OBJ_IRON_VEIN, 0, "Iron ore", "iron_ore.qmsh"),
	BaseObject("gold_ore", OBJ_USABLE | OBJ_GOLD_VEIN, 0, "Gold ore", "gold_ore.qmsh"),
	...
	BaseObject("throne", OBJ_IMPORTANT | OBJ_REQUIRED | OBJ_USABLE | OBJ_THRONE | OBJ_NEAR_WALL, 0, "Throne", "tron.qmsh"),
	...
	BaseObject("stool", OBJ_USABLE | OBJ_STOOL, 0, "Stool", "stolek.qmsh", 0.27f, 0.44f),
	...
	BaseObject("obelisk", OBJ_PHY_BLOCKS_CAM, 0, "Obelisk", "obelisk.qmsh"),
