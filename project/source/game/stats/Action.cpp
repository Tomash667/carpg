...
//-----------------------------------------------------------------------------
Action g_actions[] = {
	Action("bull_charge", 20.f, 20.f, 1, Action::LINE, Vec2(5.f, 0.6f), "charge.wav", 3.f, Action::F_IGNORE_UNITS, 100.f),
	Action("dash", 0, 5.f, 3, Action::LINE, Vec2(7.5f, 0.25f), "dash.wav", 1.f, Action::F_PICK_DIR, 25.f),
