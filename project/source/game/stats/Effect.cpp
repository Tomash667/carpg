...
BaseEffect g_effects[] = {
	...
	BaseEffectId::Str10, EffectType::AttributeId, (int)AttributeId::STR, 10,
	BaseEffectId::Str15, EffectType::AttributeId, (int)AttributeId::STR, 15,
	BaseEffectId::Con10, EffectType::AttributeId, (int)AttributeId::END, 10,
	BaseEffectId::Con15, EffectType::AttributeId, (int)AttributeId::END, 15,
	BaseEffectId::Dex10, EffectType::AttributeId, (int)AttributeId::DEX, 10,
	BaseEffectId::Dex15, EffectType::AttributeId, (int)AttributeId::DEX, 15,
	BaseEffectId::MediumArmor10, EffectType::SkillId, (int)SkillId::MEDIUM_ARMOR, 10,
	...
	BaseEffectId::DamageGainStr5_Max30, EffectType::DamageGain, (int)AttributeId::STR, 30,
