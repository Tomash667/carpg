...
private:
	...
	void GenerateLabyrinth(Pole*& tiles, const Int2& size, const Int2& room_size, Int2& stairs, GameDirection& stairs_dir, Int2& room_pos, int grating_chance);
	void CreateStairs(Pole* tiles, const Int2& size, Int2& stairs, GameDirection& stairs_dir);
